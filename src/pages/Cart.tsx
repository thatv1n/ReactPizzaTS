...
export const Cart: React.FC = () => {
    ...
    const plusCart = (id: number) => {
        let pizza = [...cart.filter((item) => item.id === id)];
        ...
        return (
            <div key={item.id} className="cart__item">
                ...
                <div className="cart__item-info">
                    <h3>{item.name}</h3>
                    <div>
                        {item.typesPizza.map((item, i) => (
                            <p key={i}>
                                {viewTypes[item.weight]} тесто, {sizeType[item.size]} см.
                            </p>
                        ))}
                    </div>
                </div>
                ...
                <span>
                  ...
                  Сумма заказа: <b>{totalPrice} ₽</b>
                            ...
                            <div className="cart__bottom-buttons">
                                <Link to="/ReactPizzaTS" className="button button--outline button--add go-back-btn">
                                    <svg
                                        width="8"
                                        height="14"
                                        viewBox="0 0 8 14"
